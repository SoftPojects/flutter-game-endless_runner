...
class Obstacle extends SpriteComponent with HasWorldReference<EndlessWorld> {
  ...
  Obstacle.tall({super.position})
    : _srcSize = Vector2(32, 48),
      ...
      super(size: Vector2(100, 200), anchor: Anchor.bottomLeft);
  ...
  final List<String> obstacleAssets = [
    'enemies/obstacle-ipan.png',
    'enemies/obstacle-paiz.png',
  ];
  ...
  Future<void> onLoad() async {
    ...
    final randomObstacle =
        obstacleAssets[random.nextInt(obstacleAssets.length)];
